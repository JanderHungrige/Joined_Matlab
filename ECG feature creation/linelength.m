function LL=linelength(ECG,t_ECG) 
%Input
...
LL{1,1}=LL{1,2}; % due to nan, cannot be determined correctly. leaving nan ut still gives false result. rather copy next as they might be similar
end
% %%%%%%%%%%%% SAVING            
